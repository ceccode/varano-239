export const villageChatsMessages = {
  ...
  "core.message.level2.intro":
    "Attraversa vicoli e muretti, recupera i tre indizi sul mittente e arriva al muretto del Castello. Tieni premuta la direzione: dopo un attimo parte lo SCATTO, e serve per i salti larghi.",
